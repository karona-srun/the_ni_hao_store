...
<body>
    <div class="header">
        ...
        <div class="container">
            ...
            <div class="logo">
                <h1><a href="index.html"><b>T<br>H<br>E</b> MAM Store<span>The Best Supermarket</span></a></h1>
            </div>
            <div class="head-t">
                <ul class="card">
                    ...
                    <li><a href="about.html"><i class="fa fa-file-text-o" aria-hidden="true"></i>ខ្មែរ</a></li>
                    <li><a href="shipping.html"><i class="fa fa-ship" aria-hidden="true"></i>English</a></li>
                </ul>
            </div>
                ...
                <nav class="navbar navbar-default">
                    ...
                    <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                        <ul class="nav navbar-nav ">
                            <li class=" active"><a href="index.html" class="hyper "><span>Home</span></a>
                            </li>
                            <li class="dropdown ">
                                <a href="#" class="dropdown-toggle  hyper" data-toggle="dropdown"><span>Electronics<b
    ...
    <div class="footer">
        <div class="container">
            ...
            <div class="footer-bottom">
                <h2><a href="index.html"><b>T<br>H<br>E</b>MAM Store<span>The Best Supermarket</span></a></h2>
                <p class="fo-para">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                ...
                <div class=" address">
                    <div class="col-md-4 fo-grid1">
                        <p><i class="fa fa-home" aria-hidden="true"></i>12K Street , 45 Building Road Phnom Penh
                            Cambodia.</p>
                    </div>
                    <div class="col-md-4 fo-grid1">
            ...
            <div class="copy-right">
                <p> &copy; {{ now()->year - 1 }} - {{ now()->year }} MAM store. All Rights Reserved</p>
            </div>
        </div>
    </div>
    <!-- //footer-->
