    ...
    <div class="wrapper">
                        ...
                        <a href="#" class="dropdown-item">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="text-sm">Call me whenever you can...</p>
                                    <button type="button" class=" text-left btn btn-primary btn-block btn-sm mb-2"><i class="fas fa-tasks mr-2"></i> Administrator</button>
                                    <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i>Logged In 4 Hours Ago</p>
                                </div>
                            </div>
                        </a>
                        <a href="#" class="dropdown-item">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ url('/dashboard') }}" class="brand-link text-center">
                <span class="brand-text font-bold text-lg">{{ config('app.name', 'Laravel') }}</span>
            </a>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; {{ now()->year - 1 }} - {{ now()->year }} <a href="https://adminlte.io">THE MAM
                    Store</a>.</strong>
            All rights reserved.
        </footer>
    </div>
